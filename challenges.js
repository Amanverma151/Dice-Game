...
document.querySelector(".btn--roll").addEventListener('click', function () {
    ...
    if (gamePlaying) {
       ...
       document.getElementById("dice-2").style.display="block";
        ...
        // if the user rolls 2 sixes in row
...
document.querySelector(".btn--hold").addEventListener("click", function () {
    ...
    if (gamePlaying) {
        ...
        // ".value " function returns the value of the text entered by the user in the input field of the html

        var input= document.querySelector(".final").value;
        var winningscore;
        // to set user defined winning score
        if(input)
        {
            winningscore=input;
        }
